...
```shell
gem install ./cbrain_client-6.4.0.gem
```
(for development, run `gem install --dev ./cbrain_client-6.4.0.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'cbrain_client', '~> 6.4.0'
