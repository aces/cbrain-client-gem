...
module CbrainClient
  class ToolConfig
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ncpus')
        self.ncpus = attributes[:'ncpus']
      end
    end
    ...
    def hash
      [id, version_name, description, tool_id, bourreau_id, group_id, ncpus].hash
    end
