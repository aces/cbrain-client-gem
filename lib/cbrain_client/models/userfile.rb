...
module CbrainClient
  class Userfile
    ...
    # The intermediate path of the file, but only on DataProviders that are of type
    # MultiLevel. Otherwise the value is null
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'browse_path')
        self.name = attributes[:'browse_path']
      end
    ...
    def hash
      [id, name, browse_path, size, user_id, parent_id, type, group_id, data_provider_id, group_writable, num_files, hidden, immutable, archived, description].hash
    end
