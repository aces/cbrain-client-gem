...
module CbrainClient
  class MultiUserfilesModReq
    ...
    attr_accessor :data_provider_id_for_mv_cp

    # The name of the archive file that the Userfiles will be compressed into when downloading.
    attr_accessor :specified_filename
    ...
    def self.swagger_types
      {
        ...
        :'data_provider_id_for_mv_cp' => :'Integer',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'file_ids')
        if (value = attributes[:'file_ids']).is_a?(Array)
          self.file_ids = value
        end
      end

      if attributes.has_key?(:'data_provider_id_for_mv_cp')
        self.data_provider_id_for_mv_cp = attributes[:'data_provider_id_for_mv_cp']
      end

      if attributes.has_key?(:'specified_filename')
        self.specified_filename = attributes[:'specified_filename']
      end

      if attributes.has_key?(:'operation')
        self.operation = attributes[:'operation']
      else
        self.operation = 'sync_local'
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          file_ids == o.file_ids &&
          data_provider_id_for_mv_cp == o.data_provider_id_for_mv_cp &&
          specified_filename == o.specified_filename &&
    ...
    def hash
      [file_ids, data_provider_id_for_mv_cp, specified_filename, operation].hash
    end
